...
import com.pkl.stafftracking.Controller.AppController;
...
public class LoginActivity extends AppCompatActivity {
    ...
    private String url =  "https://trackingforadmin.000webhostapp.com/login.php";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        txt_username = (TextInputEditText) findViewById(R.id.login_email);
