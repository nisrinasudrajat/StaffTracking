...
import com.pkl.stafftracking.Adapter.MasukAdapter;
...
public class MasukFragment extends Fragment {
    ...
    private static final String URL_PRODUCTS = "https://trackingforadmin.000webhostapp.com/rekap_user_masuk.php";
                    ...
                    public void onResponse(String response) {
                        try {
                            ...
                            for (int i = 0; i < array.length(); i++) {
                                ...
                                JSONObject masuk = array.getJSONObject(i);

                                //adding the product to product list
                                masukList.add(new Masuk(
                                        masuk.getString("hari"),
                                        masuk.getString("tanggal"),
                                        masuk.getString("jam"),
                                        masuk.getString("nama")
                                ));
                            }

                            MasukAdapter adapter = new MasukAdapter(getActivity(), masukList);
